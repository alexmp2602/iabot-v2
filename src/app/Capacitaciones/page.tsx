        ...
        <section className="py-12 pb-4">
          ...
          <div className="grid grid-cols-1 gap-6 px-8 md:grid-cols-2 lg:grid-cols-4">
            {[
              ...
              <Card
                key={index}
                className="transform overflow-hidden rounded-lg bg-[#E8F5E9] shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-xl dark:bg-[#E8F5E9]"
              >
          ...
          <div className="container mx-auto px-4 pt-14">
            <h1 className="mb-12 text-center font-bruno text-3xl font-bold">
