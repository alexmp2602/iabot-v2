  ...
  return (
    <div className="bg-custom-radial text-black">
      <header className="bg-primary py-20 text-center">
        <h2 className="font-bruno text-4xl font-bold">CONTÁCTANOS</h2>
      ...
      <main className="container mx-auto px-4 py-8">
        <Card className="mx-auto w-full max-w-lg bg-[#E8F5E9] p-6 shadow-md dark:bg-[#E8F5E9]">
          <CardHeader>
            ...
            <div className="grid grid-cols-1 gap-6 text-black sm:grid-cols-1">
              {[
                ...
                },
                {
                  ...
                  title: "Dirección",
                  detail: "C. 21 336, Mercedes, Provincia de Buenos Aires",
