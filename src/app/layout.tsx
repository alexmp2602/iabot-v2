...
export const metadata: Metadata = {
  ...
  keywords:
    "robótica, educación, capacitación, docentes, IABOT, LEGO, SPIKE, Prime, EV3, WeDo, cursos de robótica para docentes, kits de robótica educativa, capacitación en robótica educativa",
  ...
  return (
    <>
      <Head>
        ...
        <link
          rel="stylesheet"
          href="https://fonts.googleapis.com/css2?family=Bruno+Ace&family=Avenir+LT+Std:wght@400&display=swap"
        />
