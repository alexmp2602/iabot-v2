...
const AnimatedButton = () => {
  return (
    <div className="relative">
      <button
        className="relative flex items-center gap-2 px-10 py-5 text-lg font-semibold text-black dark:text-black bg-primary dark:bg-primaryDark rounded-full shadow-[0_0_0_2px] shadow-primary cursor-pointer overflow-hidden transition-all duration-600 ease-[cubic-bezier(0.23,1,0.32,1)] hover:bg-secondary hover:text-black dark:hover:text-black hover:shadow-[0_0_0_12px_transparent] hover:rounded-xl active:scale-95 active:shadow-[0_0_0_4px] focus:outline-none focus:ring focus:ring-offset-2 focus:ring-secondary"
      ...
      >
        ...
        <span className="relative z-10 translate-x-[-12px] transition-all duration-800 ease-[cubic-bezier(0.23,1,0.32,1)]">
          INSCRIBITE
        </span>
